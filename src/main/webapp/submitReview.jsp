...
<head>
    ...
    <style>
        ...
        .btn-secondary {
            background-color: #6b7280; /* Gray-500 for contrast */
            color: #ffffff;
            border: none;
            padding: 0.5rem 1rem;
            border-radius: 0.25rem;
...
<body>
    ...
    <main class="container mx-auto mt-8 flex-grow">
        <div class="review-container p-6 max-w-md mx-auto">
            <h2 class="text-2xl font-bold text-center text-dark mb-6">Submit Review</h2>
            <%
            ...
            <form action="review" method="post" class="space-y-4">
                ...
                <div class="flex justify-between">
                    <button type="submit" class="w-1/2 btn-primary mr-2">
                        Submit Review
                    </button>
                    <a href="order?action=history" class="w-1/2 btn-secondary text-center">
                        Cancel
                    </a>
                </div>
            </form>
